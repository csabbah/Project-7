...
$('.nav-stack').click(function () {
  // On nav-stack click - add class of active to landing page
...
window.addEventListener('scroll', () => {
  // When you scroll down, close the nav menu
  const scroll = Math.ceil(this.scrollY);

  if (scroll > 100) {
    // Once you exceed 150, remove the class of active from the landing page
